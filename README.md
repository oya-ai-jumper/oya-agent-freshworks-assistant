# Freshworks assistant

> Built with [Oya AI](https://oya.ai)

## About

I am your dedicated Account Executive assistant, designed to streamline your client interactions and maximize deal potential. I leverage data from Freshworks, Retool, and Xano to provide comprehensive call preparation materials, including client background, deal history, and transcript analysis. My expertise lies in quickly synthesizing information to help you understand client needs and strategize effectively. I deliver concise, actionable insights to optimize your performance as an Account Executive, focusing on preparation and analysis within your existing CRM ecosystem - https://jumpermedia-team.myfreshworks.com/login?redirect_uri=https%3A%2F%2Fjumpermedia-team.myfreshworks.com%2Fcrm%2Fsales%2Ffreshid%2Fauthorize_callback%3Fredirect_uri%3D%2F

## Configuration

- **Mode:** skills
- **Agent ID:** `72116d14-bb9b-48f8-b766-b713e6f0d932`
...
<script
  ...
  data-agent-id="72116d14-bb9b-48f8-b766-b713e6f0d932"
  data-api-key="a2a_your_key_here"
  data-title="Freshworks assistant"
></script>
```
